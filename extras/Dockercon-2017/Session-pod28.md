...
[root@pod28-srv1 ~]# 
[root@pod28-srv1 ~]# cd ~
[root@pod28-srv1 ~]# sed -i -e '$a export DOCKER_HOST=tcp://pod28-srv1.ecatsrtpdmz.cisco.com:2375' .bashrc
[root@pod28-srv1 ~]# cat .bashrc
# .bashrc
...
export DOCKER_HOST=tcp://pod28-srv1.ecatsrtpdmz.cisco.com:2375
[root@pod28-srv1 ~]# 
...
[root@pod28-srv2 ~]# 
[root@pod28-srv2 ~]# cd ~
[root@pod28-srv2 ~]# sed -i -e '$a export DOCKER_HOST=tcp://pod28-srv1.ecatsrtpdmz.cisco.com:2375' .bashrc
[root@pod28-srv2 ~]# cat .bashrc
# .bashrc
...
```
[root@pod28-srv1 ~]# [root@pod28-srv1 ~]# docker network ls
